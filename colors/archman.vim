...
hi LineNr ctermfg=23 ctermbg=NONE cterm=NONE guifg=#76A9DB guibg=NONE gui=NONE
...
hi Search ctermfg=NONE ctermbg=13 cterm=underline guifg=NONE guibg=#FFFF00 gui=underline
hi Directory ctermfg=56 ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi Folded ctermfg=21 ctermbg=235 cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
...
hi Conditional ctermfg=1 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi Keyword ctermfg=1 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi Number ctermfg=4  ctermbg=NONE cterm=NONE guifg=#7F4EFE guibg=NONE gui=NONE
hi Operator ctermfg=1 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi Statement ctermfg=1 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi Tag ctermfg=1 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
...
hi rubyOperator ctermfg=1 ctermbg=NONE cterm=NONE guifg=#FF4143 guibg=NONE gui=NONE
